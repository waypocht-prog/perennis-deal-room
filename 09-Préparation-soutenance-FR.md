...
## 1. 🎬 Pitch d'ouverture (~2 min — à dire au début)

« Bonjour. Je vous présente **Pérennis**, une plateforme d'IA et un cabinet de conseil
M&A dédiés à la **transmission d'entreprises** en Europe.

**Le problème :** des centaines de milliers de PME rentables risquent de disparaître — non
pas parce qu'elles échouent, mais parce que leurs dirigeants vieillissent **sans
successeur**. En France, près de **500 000 dirigeants** partiront à la retraite, et **une
entreprise sur deux ne trouve pas de repreneur**.

**L'insight :** le marché est déséquilibré — il y a **trois fois plus de vendeurs que
d'acheteurs**. Le facteur rare, ce n'est pas l'entreprise à vendre, c'est **l'acheteur
solvable et de confiance**.

**La solution :** Pérennis relie les deux rives. Une **plateforme d'agents d'IA** détecte,
valorise et met en correspondance les entreprises, avec un **guichet de conformité**
intégré ; et j'apporte un **réseau propriétaire d'acheteurs** de la CEI et du Moyen-Orient,
à qui je parle leur langue. Nous accompagnons la transaction de A à Z, et proposons un
**management de transition** pour une reprise sereine.

**L'impact :** un sourcing **3,7 fois plus productif**, un cycle ramené de plus de 12 mois
à moins de 6, et, à maturité, un résultat net de l'ordre de **1,9 M€** — le tout dans un
cadre strictement conforme. Je vais vous montrer une démonstration, puis le business case
et la feuille de route. »

---

## 2. ❓ Questions probables du jury + réponses modèles

### ⚖️ Conformité, sanctions & réputation (LES questions décisives)

**Q : Des capitaux venus de la CEI et du Moyen-Orient — n'est-ce pas un risque de
blanchiment ou de contournement de sanctions ?**
R : « C'est le risque n°1, et je le traite en priorité, pas en dernier. Chaque acheteur
passe un **guichet de conformité obligatoire** : KYC des bénéficiaires effectifs, contrôle
de l'**origine des fonds**, criblage **sanctions et PEP** (listes UN, OFAC, UE, UK), et
vérification de l'exposition au **filtrage des IDE** de l'UE. Au moindre doute — une
...
origine des fonds documentée), la **continuité** (préservation des emplois et du
...
**Q : Pourquoi une IA, et pas un cabinet M&A classique ?**
R : « Parce que le sourcing manuel est lent : un analyste qualifie ~40 cibles par mois. Mes
agents d'IA scrutent en continu les registres et la presse, et un analyste en supervise
~150 — **3,7 fois plus**, à coût par cible **−65 %**. L'IA fait le travail répétitif ;
l'humain garde les relations et les décisions. »

**Q : Et si l'IA se trompe sur une valorisation ou invente une donnée (hallucination) ?**
R : « Deux garde-fous. D'abord le **grounding** : les agents ne s'appuient que sur des
...
aux données sans *vendor lock-in* : je peux changer de modèle ou de source sans réécrire le
système, et **héberger les données dans l'UE** — un atout RGPD. »

### 💰 Business case & ROI

**Q : Vos chiffres — 50 M€ de volume, 1,9 M€ de résultat — sont-ils réalistes ?**
R : « Ce sont des hypothèses prudentes, pour un **régime de maturité** (année 2-3). Je suis
...
mensuel par mandat, et le **management de transition** (une ligne à part). »

### 🚀 Modèle, risques & mise en œuvre

**Q : Votre avantage repose sur votre réseau personnel. Qu'est-ce qui vous protège ?**
...
cibles pour eux. Rapide, peu coûteux, et cela exploite immédiatement mon avantage. La
première transaction est réaliste au **mois 9-15**. »

**Q : Quel est votre statut réglementaire en France ?**
R : « Le conseil en M&A n'est pas une profession réglementée, mais j'adhère à la **CNCFA**
...
dirigeants et d'acheteurs. J'ai donc une base légale, un registre des traitements, un DPO,
un hébergement dans l'UE, et le respect des droits des personnes. »

---

## 3. 💡 Conseils pour la soutenance
- **Montre la démo tôt** : le guichet de conformité est ton moment le plus fort.
- **Sur la conformité, sois ferme et précis** — c'est là que tu prouves ta maturité.
- **Assume les limites** : « Bonne question — au pilote, je le validerais en mesurant X. »
- **Reviens toujours au réel** : emplois sauvés, savoir-faire préservé, capital légitime.
